          ...
          return (
            <>
              <SwiperSlide className="relative">
                ...
                <div className="moveFromTop w-[45%]   absolute z-20 text-orange-600 top-[42%] left-[16%]">
                  <p className=" flex items-center gap-[30px] satisfy-regular text-[14px] md:text-[18px] xl:text-[24px] lg:text-[20px] xl:leading-[32px] lg:leading-[25px] mb-4">
                    <svg
                      width="67"
                      height="12"
                      viewBox="0 0 67 12"
