    ...
    <>
      <section className="bg-siteBg">
        <div className="py-20  bg-[url('/photo/download2.png')] bg-no-repeat bg-cover">
          <div className="xs:gap-0 md:gap-0 grid grid-cols-12 lg:gap-[6.5rem] xl:gap-32 mx-[3%] ">
            <div className="relative xs:col-span-12 md:col-span-12  lg:col-span-5">
              <div className=" xs:max-w-fit xs:h-[500px] md:max-w-fit md:mx-auto lg:mx-0 lg:max-w-[516px]  h-[640px]">
                <Image
                ...
                ></Image>
                <span className="xs:w-[120px] xs:h-[120px] xs:right-[12px] md:right-[129px] lg:right-0  text-white bg-siteColor w-[130px] h-[130px] absolute top-0 rounded-[7px] gap-[5px] flex justify-center items-center flex-col">
                  <IoIosStar className="xs:text-[25px] text-[30px]" />5 Star
                  Rating
                </span>
              </div>
              <div className="xs:w-[180px] xs:h-[180px] xs:bottom-[3rem] xs:right-0 md:right-[0px] lg:right-[-5rem]   xl:right-[-7rem]  w-[304px] h-[304px] absolute bottom-[5rem] ">
                <Image src={"/photo/our-resturent-2.png"} alt="" fill></Image>
              </div>
            </div>
            <div className="md:mt-10 lg:mt-0  xs:col-span-12 md:col-span-12 lg:col-span-5 xl:col-span-6">
              <div className="xs:my-[19px] satisfy-regular  text-siteColor flex gap-[15px] text-[24px] mb-[19px] ">
                <Image
                  src={"/svg/fork.svg"}
                  alt="img"
                  width={13}
              ...
              <h1 className="xs:text-[23px] lg:text-[39px] fontTitle xl:text-[50px] font-semibold text-white mb-4 lg:mb-[20px] xl:mb-[33px]">
              ...
              <div className="xs:block flex md:gap-8 lg:gap-4 xl:gap-8 mt-[30px] mb-[60px]">
                <div className="mb-7 xs:text-center">
                  <span className="xs:mx-auto w-[50px] h-[50px] bg-siteColor rounded-full flex items-center justify-center mb-4 lg:mb-[25px] xl:mb-[30px]">
