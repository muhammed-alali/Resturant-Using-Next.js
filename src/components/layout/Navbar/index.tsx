...
const NavList = ({
  ...
  return (
    <ul className="text-white lg:w-1/2 md:w-[75%] md:!gap-7 w-full mx-auto md:space-y-0 space-y-7 xs:mb-48 md:mb-0 flex items-center justify-between md:flex-row flex-col font-semibold">
      {mobileNav ? (
